...
VectorXd BCResidues(MatrixXd x_BC){
    VectorXd residues(6);
    residues(0) = x_BC(0,0) - 1.076;
    residues(1) = x_BC(1,0) + pow(x_BC(1,0),2) + x_BC(1,1) + x_BC(1,2) + x_BC(1,3) + 2.053292953504164;
    residues(2) = x_BC(2,0) + x_BC(3,0) - 0.472283099142472;
    residues(3) = pow(x_BC(3,1),2) + x_BC(4,2) - 1.040204804411078;
    residues(4) = x_BC(2,3) + x_BC(4,3) - 1.57661; 
    residues(5) = x_BC(5,3) + 0.03407297218269353;
    return residues;
}
// ===================
