...
int main(
    ...
    /* Boundary Value Problem 1 */
    bvpSolution = nlmp_bvp<mpreal>(2, 2, 101, tBC, oxt1, dxBydt, BCResidues, ivamParameters);

    /* Boundary Value Problem 2 */
    // bvpSolution = nlmp_bvp<mpreal>(3, 3, 101, tBC, oxt1, dxBydt, BCResidues, ivamParameters);
