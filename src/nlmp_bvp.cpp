...
using RowVectorXm = Matrix<mpreal, 1, Dynamic>;***REMOVED******REMOVED******REMOVED******REMOVED***  // For the convenience of declaring row vectors
...
***REMOVED******REMOVED***  mpreal h;***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** // h***REMOVED******REMOVED******REMOVED******REMOVED***= the stepper step size for the IVP solver***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***-- [0,nGrid-1] 
***REMOVED******REMOVED***  mpreal t0;***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***// t0***REMOVED******REMOVED******REMOVED***  = the first boundary value of the independent variable
***REMOVED******REMOVED***  mpreal tm;***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***// tm***REMOVED******REMOVED******REMOVED***  = the last boundary value of the independent variable
***REMOVED******REMOVED***  mpreal kepsilonj;***REMOVED******REMOVED******REMOVED***  // kepsilonj = the perturbation parameter for a state variable at a particular iteration k
***REMOVED******REMOVED***  mpreal kalpha;***REMOVED******REMOVED******REMOVED******REMOVED***// kalpha***REMOVED***  = the relaxation factor at a particular iteration k to scale the adjustment to the initial condition 
...
***REMOVED******REMOVED***  VectorXm kxt1P(n);***REMOVED******REMOVED*** // kxt1***REMOVED******REMOVED***= the computed perturbed initial state vector in the k-th iteration***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** -- (nx1)
***REMOVED******REMOVED***  VectorXm xt1(n);***REMOVED******REMOVED******REMOVED***  // xt1***REMOVED******REMOVED******REMOVED***= the computed initial state vector to be input to the IVP solver***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***-- (nx1)
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** cout<<"k = "<<k<<"... kG = "<<kG<<"... kGPrev = "<<kGPrev<<" alpha = "<<kalpha<<" Inc alpha..."<<endl;
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** kalpha = fmin(1.2*kalpha, 1.0); 
***REMOVED******REMOVED******REMOVED******REMOVED***} else if(kG >= kGPrev){
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED*** cout<<"k = "<<k<<"... kG = "<<kG<<"... kGPrev = "<<kGPrev<<" alpha = "<<kalpha<<" Dec alpha..."<<endl;***REMOVED******REMOVED******REMOVED******REMOVED*** 
